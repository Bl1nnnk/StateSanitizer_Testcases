...
int A()
{
    ...
    LPCWSTR filename = L"dir//1.txt:stream1"; // 指定带有流名称的文件路径
    ...
    tp_hypercall(TP_FUNC_BEGIN_FUZZ, 0);
    HANDLE hChange = CreateMutex(NULL, FALSE, (LPCWSTR)"MyMutex"); // 创建一个监视器
